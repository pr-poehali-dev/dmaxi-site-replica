    ...
    <footer className="bg-card border-t border-border mt-auto">
      <div className="container mx-auto py-14">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground leading-relaxed mb-5">
              Профессиональный ремонт и обслуживание автомобилей. Клубная система скидок для постоянных клиентов.
            </p>
            <div className="flex gap-2">
              {["VK", "TG", "YT"].map((s) => (
                <button key={s} className="w-8 h-8 border border-border text-muted-foreground hover:border-primary hover:text-primary transition-colors text-[10px] font-display font-bold tracking-wide">
                  {s}
                </button>
              ))}
            </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <div>
                  <div className="text-sm font-semibold">+7 (3952) 00-00-00</div>
              ...
              <li className="flex items-start gap-3">
                ...
                <div>
                  <div className="text-sm">Иркутск, ул. Верхоленская</div>
              ...
              <li className="flex items-start gap-3">
                ...
                <div>
                  <div className="text-sm">Пн–Сб 9:00–21:00</div>
                  <div className="label-tag mt-0.5">Воскресенье — выходной</div>
                </div>
              </li>
              <li className="flex items-start gap-3">
                <Icon name="Mail" size={14} className="text-primary shrink-0 mt-0.5" />
                <div className="text-sm">info@d-d-maxi.ru</div>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-border mt-10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3">
          <span className="text-xs text-muted-foreground">© 2024 DD MAXI. Все права защищены.</span>
